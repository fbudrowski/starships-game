...
import { getGame, sellItemsWrapper, buyItemsWrapper, travelWrapper, returnGame } from "./objectsModel";
...
export function setTravelingStarshipWindow(starship) {
    ...
    for (let planetItem in planetItems) {
        ...
        <td><button class="action-button" id="${realItem.name}-sell-button"${(ship.travel_remaining_time === 0
